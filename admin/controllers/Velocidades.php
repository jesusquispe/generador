...
class Velocidades extends CI_Controller {
            ...
            if($this->input->is_ajax_request()){
                ...
                $this->form_validation->set_rules('estado', 'Estado', 'required');//while
                    ...
                    else
                    {
                        ...
                        if($this->velocidades_model->insert_entry($ajax_data)){
        ...
        {
            if($this->input->is_ajax_request()){
                $posts = $this->velocidades_model->get_entries();
        ...
        public function delete(){
            if($this->input->is_ajax_request())
            {
                ...
                if($this->velocidades_model->delete_entry($del_id)){
        ...
        public function edit(){
            if($this->input->is_ajax_request())
            {
                ...
                if($post = $this->velocidades_model->single_entry($edit_id)){
        ...
        public function update(){
            if($this->input->is_ajax_request()){
                ...
                else
                {
                    ...
                    if($this->velocidades_model->update_entry($data)){
