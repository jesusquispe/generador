...
class Roles extends CI_Controller {
            ...
            if($this->input->is_ajax_request()){
                ...
                $this->form_validation->set_rules('descripcion', 'Descripcion', 'required');//while
                    ...
                    else
                    {
                        ...
                        if($this->roles_model->insert_entry($ajax_data)){
        ...
        {
            if($this->input->is_ajax_request()){
                $posts = $this->roles_model->get_entries();
        ...
        public function delete(){
            if($this->input->is_ajax_request())
            {
                ...
                if($this->roles_model->delete_entry($del_id)){
        ...
        public function edit(){
            if($this->input->is_ajax_request())
            {
                ...
                if($post = $this->roles_model->single_entry($edit_id)){
        ...
        public function update(){
            if($this->input->is_ajax_request()){
                ...
                else
                {
                    ...
                    if($this->roles_model->update_entry($data)){
