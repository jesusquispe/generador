        ...
        function fetch(){
            $.ajax({
                ...
                for(var key in data){
                    ...
                    tbody += "<td>"+ data[key]['persona_id']+"</td>";
        ...
        $(document).on("click","#edit",function(e){
            ...
            if(edit_id==""){
              ...
              $.ajax({
                ...
                $("#edit_modal_id").val(data.post.id);$("#edit_persona_id").val(data.post.persona_id);
            ...
            var edit_persona_id = $("#edit_persona_id").val();
            var edit_estado = $("#edit_estado").val();
                        
                if(edit_id == "" || edit_persona_id == "" || edit_estado == "" || ){
                    ...
                    edit_id: edit_id,    
                    edit_persona_id: edit_persona_id,    
