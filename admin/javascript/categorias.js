        ...
        $(document).on("click","#add",function(e){
            ...
            var servicion_id = $("#servicion_id").val();
            var icono = $("#icono").val();
        ...
        function fetch(){
            $.ajax({
                ...
                for(var key in data){
                    ...
                    tbody += "<td>"+ data[key]['servicion_id']+"</td>";
                    tbody += "<td>"+ data[key]['icono']+"</td>";
        ...
        $(document).on("click","#edit",function(e){
            ...
            if(edit_id==""){
              ...
              $.ajax({
                ...
                $("#edit_modal_id").val(data.post.id);$("#edit_servicion_id").val(data.post.servicion_id);
                $("#edit_icono").val(data.post.icono);
            ...
            var edit_servicion_id = $("#edit_servicion_id").val();
            var edit_icono = $("#edit_icono").val();
            var edit_descripcion = $("#edit_descripcion").val();
                        
                if(edit_id == "" || edit_servicion_id == "" || edit_icono == "" || edit_descripcion == "" || ){
                    ...
                    edit_id: edit_id,    
                    edit_servicion_id: edit_servicion_id,    
                    edit_icono: edit_icono,    
