        ...
        $(document).on("click","#add",function(e){
            ...
            var empresa_cliente_id = $("#empresa_cliente_id").val();
        ...
        function fetch(){
            $.ajax({
                ...
                for(var key in data){
                    ...
                    tbody += "<td>"+ data[key]['departamento_id']+"</td>";
                    tbody += "<td>"+ data[key]['empresa_cliente_id']+"</td>";
        ...
        $(document).on("click","#edit",function(e){
            ...
            if(edit_id==""){
              ...
              $.ajax({
                ...
                $("#edit_modal_id").val(data.post.id);$("#edit_departamento_id").val(data.post.departamento_id);
                $("#edit_empresa_cliente_id").val(data.post.empresa_cliente_id);
            ...
            var edit_departamento_id = $("#edit_departamento_id").val();
            var edit_empresa_cliente_id = $("#edit_empresa_cliente_id").val();
            var edit_estado = $("#edit_estado").val();
            var edit_descripcion = $("#edit_descripcion").val();
            var edit_fecha = $("#edit_fecha").val();
                        
                if(edit_id == "" || edit_departamento_id == "" || edit_empresa_cliente_id == "" || edit_estado == "" || edit_descripcion == "" || edit_fecha == "" || ){
                    ...
                    edit_id: edit_id,    
                    edit_departamento_id: edit_departamento_id,    
                    edit_empresa_cliente_id: edit_empresa_cliente_id,    
