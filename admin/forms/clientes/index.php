    ...
    <div class="card-header">
    	<div class="row">
    		...
    		<div class="col-md-2 text-right">
    			<button type="button" class="btn btn-success" data-toggle="modal" data-target="#formclientesModal">Nuevo</button>
    		</div>
    		<div class="col-md-2 text-right">
          	...
          	<div class="col-sm-12">
          		...
          		<table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
					...
					<thead>
						<tr role="row">
							...
							<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 219px;">persona_id</th>
				...
				<tfoot>
                	<tr>
						...
						<th rowspan="1" colspan="1">persona_id</th>
