...
class User extends CI_Controller {
        ...
        private function _validate()
        {
            ...
            if($this->input->post('persons_id') == '')
            {
                $data['inputerror'][] = 'persons_id';
                $data['error_string'][] = 'persons_id is required';
                $data['status'] = FALSE;
            }
            ...
            if($this->input->post('contrasenia') == '')
            {
                ...
                $data['error_string'][] = 'contrasenia is required';
                $data['status'] = FALSE;
            }
            if($this->input->post('estado') == '')
            {
                $data['inputerror'][] = 'estado';
                $data['error_string'][] = 'estado is required';
                $data['status'] = FALSE;
            }
