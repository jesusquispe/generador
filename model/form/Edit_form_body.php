...
class Form_body
{
	...
	{
		return '
		<div class="modal fade" id="edit'.$id_modal.'Model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    public function form_header($name_table){
		return '
					<div class="modal-header">
						<h4 class="modal-title">Edit '.$name_table.'</h4>
